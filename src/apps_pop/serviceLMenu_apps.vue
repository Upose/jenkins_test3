...
export default {
  ...
  data () {
    return {
      ...
      dataList:[
        {icon:'el-icon-warning-outline',title:'应用管理',url:'/appManage'},
        {icon:'el-icon-warning-outline',title:'订单授权',url:'/orderMandate'},
        {icon:'el-icon-warning-outline',title:'客户管理',url:'/clientManage'},
        {icon:'el-icon-warning-outline',title:'信息发布',url:'/appManage'},
      ],
    }
  },
  methods:{
