...
export default {
  ...
  data () {
    return {
      ...
      dataList:[
        {icon:'el-icon-warning-outline',title:'系统专题管理',url:'/sysSpecial'},
        {icon:'el-icon-warning-outline',title:'热门主题管理',url:'/hotTopic'},
        {icon:'el-icon-warning-outline',title:'联盟专题审核',url:'/unionProject'},
      ],
    }
  },
  methods:{
