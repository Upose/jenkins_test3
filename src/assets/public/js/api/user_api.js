...
export default {
  postUrl: {
    ...
    "property-change-log-table-data":
      baseURL + "/api/data-approve/property-change-log-table-data", //获取属性变更日志记录
    "property-change-log-detail-items":
      baseURL + "/api/data-approve/property-change-log-detail-items", //获取属性变更详情
    "approve-property-change":
      baseURL + "/api/data-approve/approve-property-change", //审批变更日志
    "user-change-log-table-data":
      baseURL + "/api/data-approve/user-change-log-table-data", //获取读者审批变更日志记录
    "approve-user-change": baseURL + "/api/data-approve/approve-user-change", //审批读者修改日志
    "user-change-log-detail-info":
      baseURL + "/api/data-approve/user-change-log-detail-info", //获取读者信息变更详情
    "user-change-log-detail-items":
      baseURL + "/api/data-approve/user-change-log-detail-items", //获取读者变更详情
    "user-register-table-data":
      baseURL + "/api/data-approve/user-register-table-data", //获取注册审批列表数据
    "approve-user-register":
      baseURL + "/api/data-approve/approve-user-register", //审批用户注册信息
    "card-claim-table-data":
      baseURL + "/api/data-approve/card-claim-table-data", //获取读者领卡列表数据
    "approve-card-claim": baseURL + "/api/data-approve/approve-card-claim", //审批读者领卡信息
    "card-claim-detail-info":
      baseURL + "/api/data-approve/card-claim-detail-info", //读者领卡详情
    ...
    "download-user-import-template":
      baseURL + "/api/user/download-user-import-template", //用户数据导入模板下载
    ...
    "export-user-data-brief-info":
      baseURL + "/api/user/export-user-data-brief-info", //获取待导出简要信息
    "user-card-apply-list-data":
      baseURL + "/api/card/user-card-apply-list-data", //获取用户读者卡申请信息
    ...
    "merge-info-by-user-phone-and-idcard":
      baseURL + "/api/user/merge-info-by-user-phone-and-idcard", //获取用户数据需要合并信息
    "merge-user-info": baseURL + "/api/user/merge-user-info", //合并读者消息
    "with-merge": baseURL + "/api/user/with-merge", //编辑用户信息
    "reader-event-score-table-data":
      baseURL + "/api/reader/reader-event-score-table-data", //积分明细
    "reader-score-summary": baseURL + "/api/reader/reader-score-summary", //积分信息
    "reset-card-secret-verify-key":
      baseURL + "/api/card/reset-card-secret-verify-key", //获取密码重置key
    "reset-card-secret-by-verify-key":
      baseURL + "/api/card/reset-card-secret-by-verify-key", //重置密码
    ...
    "export-card-data-brief-info":
      baseURL + "/api/card/export-card-data-brief-info", //卡数据导出简要信息
    ...
    "download-group-import-template":
      baseURL + "/api/user-group/download-user-import-template", //用户数据导入模板下载1103
    ...
    "set-card-claim-reader":
      baseURL + "/api/basic-config/set-card-claim-reader", //设置认领读者卡用户
    "info-append-reader": baseURL + "/api/basic-config/info-append-reader", //查询可自己补全信息的用户
    "set-info-append-reader":
      baseURL + "/api/basic-config/set-info-append-reader", //设置补充读者信息的用户
    "reader-edit-property": baseURL + "/api/basic-config/reader-edit-property", //获取读者可编辑信息
    "set-reader-edit-property":
      baseURL + "/api/basic-config/set-reader-edit-property", //设置可编辑属性

    "sensitive-info-display":
      baseURL + "/api/basic-config/sensitive-info-display", //查询敏感信息前台设置20221213
    "set-sensitive-info-display":
      baseURL + "/api/basic-config/set-sensitive-info-display", //设置敏感信息前台设置20221213
    "reader-comple-property":
      baseURL + "/api/basic-config/reader-comple-property", //获取读者可编辑信息 20221213
    "set-reader-comple-property":
      baseURL + "/api/basic-config/set-reader-comple-property", //设置可编辑属性 20221213
    ...
    "activate-change-blocking":
      baseURL + "/api/activate-procedure/change-blocking", //修改激活场景流程阻塞状态
    // 'activate-': baseURL + '/api/activate-procedure',//创建激活场景
    // 'activate-': baseURL + '/api/activate-procedure',//修改激活场景
    "activate-definition-table-data":
      baseURL + "/api/activate-procedure/definition-table-data", //获取激活流程列表
    "activate-save-definition":
      baseURL + "/api/activate-procedure/save-definition", //保存激活流程
    "activate-activate-reader":
      baseURL + "/api/activate-procedure/activate-reader", //激活读者
    "activate-front-activate-definition-list":
      baseURL + "/api/activate-procedure/front-activate-definition-list", //获取激活流程
    "": baseURL + "", //
    "": baseURL + "", //
    "": baseURL + "", //
    "": baseURL + "" //
