    ...
    <div class="main">
      ...
      <div class="filter-d">
        ...
        <div class="filter-tabs-d" v-if="sreachData">
          ...
          <div class="categ categ1" v-if="setData && setData.canFilterCustomLabel">
            <span>按标签浏览数据库:</span>
            <div>
      ...
      <div class="data-base-list">
        ...
        <el-row :gutter="30">
          <el-col :sm="12" class="list-bg" v-if="database && database.chineseDatabases.length">
            <div class="list-title">
              <span class="tab-bg-active"></span>
              <span class="text-color">中文</span>
              <span>数据库</span>
            </div>

            <ListItem v-for="(item, index) in database.chineseDatabases" :key="index" :title="item.title" />
          </el-col>
          <el-col :sm="12" class="list-bg" v-if="database && database.foreignDatabases.length">
            <div class="list-title">
              <span class="tab-bg-active"></span>
              <span class="text-color">外文</span>
              <span>数据库</span>
            </div>

            <ListItem v-for="(item, index) in database.foreignDatabases" :key="index" :title="item.title" />
          </el-col>
          <el-col :sm="12" class="list-bg" v-if="database && database.probationDatabase.length">
            <div class="list-title">
              <span class="tab-bg-active"></span>
              <span class="text-color">试用</span>
              <span>数据库</span>
            </div>

            <ListItem v-for="(item, index) in database.probationDatabase" :key="index" :title="item.title" />
          </el-col>
          <el-col :sm="12" class="list-bg" v-if="database && database.selfBuiltDatabases.length">
            <div class="list-title">
              <span class="tab-bg-active"></span>
              <span class="text-color">自建</span>
              <span>数据库</span>
            </div>

            <ListItem v-for="(item, index) in database.selfBuiltDatabases" :key="index" :title="item.title" />
          </el-col>
          <el-col :sm="12" class="list-bg" v-if="database && database.otherDatabases.length">
            <div class="list-title">
              <span class="tab-bg-active"></span>
              <span class="text-color">其他</span>
              <span>数据库</span>
            </div>

            <ListItem v-for="(item, index) in database.otherDatabases" :key="index" :title="item.title" />
          </el-col>

          <!-- <el-col :sm="12">
            <el-row>
              <el-col :sm="24" class="list-bg">
                <div class="list-title">
                  <span class="tab-bg-active"></span>
                  <span class="text-color">英文</span>
                  <span>数据库</span>
                </div>
                <ListItem v-for="(item, index) in 20" :key="index" title="中国知网(CNK1):期刊论文学位论文会议论文报纸" />
              </el-col>
              <el-col :sm="24" class="list-bg">
                <div class="list-title">
                  <span class="tab-bg-active"></span>
                  <span class="text-color">特色</span>
                  <span>数据库</span>
                </div>
                <ListItem v-for="(item, index) in 10" :key="index" title="中国知网(CNK1):期刊论文学位论文会议论文报纸" />
              </el-col>
            </el-row>
          </el-col> -->
        </el-row>
...
export default {
  ...
  methods: {
    ...
    // 获取数据库列表
    getDatabase() {
      this.http.getJson('database-single-page-list-portal', this.postForm).then(res => {
...
.page-w {
  ...
  .data-base-list {
    ...
    .el-row {
      .list-bg {
        background: url(../../../../assets/web/img/tile-bgs2.png) no-repeat;
