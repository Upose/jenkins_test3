...
export default {
  ...
  data () {
    return {
      ...
      dataList:[
        {icon:'el-icon-warning-outline',title:'总导航管理',url:'/databaseNav'},
        {icon:'el-icon-warning-outline',title:'导航栏目管理',url:'/databaseNavigation'},
        {icon:'el-icon-warning-outline',title:'导航属性管理',url:'/databaseAttr'},
        {icon:'el-icon-warning-outline',title:'应用设置',url:'/databaseSet'},
      ],
    }
  },
  methods:{
