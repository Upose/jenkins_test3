<template>
  <el-dialog append-to-body title="修改日志记录" :visible.sync="dialogVisible" width="700px" :before-close="dialogBeforeClose">
    <div class="form-box">
      <el-form ref="form" :model="postFrom" label-width="0px">
        <el-form-item label="">
          ...
          <el-button type="primary" size="medium" icon="iconfont el-icon-vip-fangdajing" @click="getList" v-button-debounce>搜索</el-button>
        </el-form-item>
      </el-form>
    </div>
