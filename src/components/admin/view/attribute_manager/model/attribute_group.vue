<template>
  <div>
    ...
    <div class="t-p">
      <el-table stripe ref="singleTable" :data="isAuth('propertyGroup:list')?tableData:[]" @selection-change="handleSelectionApp" border class="admin-table" :header-cell-style="{background:'#F1F3F7'}">
