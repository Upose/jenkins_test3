...
<template>
  <div class="admin-warp-page">
    <el-container>
      <el-aside width="auto" :collapse="$root.collapse" :class="$root.collapse?'fold-menu':''"><serviceLMenu :isActive="6"></serviceLMenu></el-aside>
      <el-main class="admin-content pd admin-bg-top" :class="{'content-collapse':$root.collapse}">
        <breadcrumb :cuMenu="'读者账号详情'" :fontColor="'fff'"></breadcrumb><!--面包屑导航--->
                    ...
                    <el-form-item label="发送时间">
                        ...
                        <div class="time-right" v-if="isShowTime">
                              ...
                              <el-date-picker
                                v-model="date"
                                type="date"
                                placeholder="选择日期" class="datelist">
                              </el-date-picker>
                          </div>
                    </el-form-item>
...
.editdiv ul li,/deep/ .el-form-item{
    width:100%;
    display: table;
    padding:1% 0 0.5% 0;
}
