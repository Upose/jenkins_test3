    ...
    var t = {
        21: (t, e, i) => {
          ...
          e.GridStackDD = n, o.GridStack.prototype._setupAcceptWidget = function () {
            if (this.opts.staticGrid || !this.opts.acceptWidgets) return n.get().droppable(this.el, "destroy"), this;
            let t, e, i, s = (s, o, l) => {
              ...
              if (a._temporaryRemoved) {
                if (a.x = Math.max(0, Math.round(d / i)), a.y = Math.max(0, Math.round(g / e)), delete a.autoPosition, this.engine.nodeBoundFix(a), !this.engine.willItFit(a)) {
                  if (a.autoPosition = !0, !this.engine.willItFit(a)) return void n.get().off(o, "drag");
                  a._willFitPos && (r.Utils.copyPos(a, a._willFitPos), delete a._willFitPos)
                }
                this._onStartMoving(l, s, p, a, i, e)
              } else this._dragOrResize(l, s, p, a, i, e)
            };
            return n.get().droppable(this.el, {
              ...
              if (h && h.grid === this && !h._temporaryRemoved) return !1;
              h && h.grid && h.grid !== this && !h._temporaryRemoved && h.grid._leave(r, a);
              let d = this.el.getBoundingClientRect();
              t = {
                top: d.top,
                left: d.left
              }, i = this.cellWidth(), e = this.getCellHeight(!0), h || (h = this._readAttr(r)), h.grid || (h._isExternal = !0, r.gridstackNode = h), a = a || r;
              let g = h.w || Math.round(a.offsetWidth / i) || 1,
                p = h.h || Math.round(a.offsetHeight / e) || 1;
              return h.grid && h.grid !== this ? (r._gridstackNodeOrig || (r._gridstackNodeOrig = h), r.gridstackNode = h = Object.assign(Object.assign({}, h), {
                w: g,
                h: p,
                grid: this
              }), this.engine.cleanupNode(h).nodeBoundFix(h), h._initDD = h._isExternal = h._temporaryRemoved = !0) : (h.w = g, h.h = p, h._temporaryRemoved = !0), l(h.el, !1), n.get().on(r, "drag", s), s(o, r, a), !1
            })).on(this.el, "dropout", ((t, e, i) => {
              let s = e.gridstackNode;
              return s.grid && s.grid !== this || this._leave(e, i), !1
            })).on(this.el, "drop", ((t, e, i) => {
              let s = e.gridstackNode;
              if (s && s.grid === this && !s._isExternal) return !1;
              let o = !!this.placeholder.parentElement;
              this.placeholder.remove();
              let l = e._gridstackNodeOrig;
              if (delete e._gridstackNodeOrig, o && l && l.grid && l.grid !== this) {
                let t = l.grid;
                t.engine.removedNodes.push(l), t._triggerRemoveEvent()
              }
              return !!s && (o && (this.engine.cleanupNode(s), s.grid = this), n.get().off(e, "drag"), i !== e ? (i.remove(), e.gridstackNode = l, o && (e = e.cloneNode(!0))) : (e.remove(), n.get().remove(e)), !!o && (e.gridstackNode = s, s.el = e, r.Utils.copyPos(s, this._readAttr(this.placeholder)), r.Utils.removePositioningStyles(e), this._writeAttr(e, s), this.el.appendChild(e), this._updateContainerHeight(), this.engine.addedNodes.push(s), this._triggerAddEvent(), this._triggerChangeEvent(), this.engine.endUpdate(), this._gsEventHandler.dropped && this._gsEventHandler.dropped({
                type: "dropped"
            ...
            let i, s;
            if (t && (i = t, s = Object.assign(Object.assign({}, {
                revert: "invalid",
            ...
            let e = t.el,
              i = n.get();
            if (this.opts.staticGrid || (t.noMove || this.opts.disableDrag) && (t.noResize || this.opts.disableResize)) return t._initDD && (i.remove(e), delete t._initDD), e.classList.add("ui-draggable-disabled", "ui-resizable-disabled"), this;
            if (!t._initDD) {
              let s, o, n = (i, r) => {
                  this._gsEventHandler[i.type] && this._gsEventHandler[i.type](i, i.target), s = this.cellWidth(), o = this.getCellHeight(!0), this._onStartMoving(e, i, r, t, s, o)
                },
                l = (i, r) => {
                  this._dragOrResize(e, i, r, t, s, o)
                },
                a = s => {
                  this.placeholder.remove(), delete t._moving, delete t._lastTried;
                  let o = s.target;
                  if (o.gridstackNode && o.gridstackNode.grid === this) {
                    if (t.el = o, t._isAboutToRemove) {
                      let r = e.gridstackNode.grid;
                      r._gsEventHandler[s.type] && r._gsEventHandler[s.type](s, o), i.remove(e), r.engine.removedNodes.push(t), r._triggerRemoveEvent(), delete e.gridstackNode, delete t.el, e.remove()
                    } else t._temporaryRemoved ? (r.Utils.removePositioningStyles(o), r.Utils.copyPos(t, t._orig), this._writePosAttr(o, t), this.engine.addNode(t)) : (r.Utils.removePositioningStyles(o), this._writePosAttr(o, t)), this._gsEventHandler[s.type] && this._gsEventHandler[s.type](s, o);
            ...
            if (this.engine.cleanNodes().beginUpdate(s), this._writePosAttr(this.placeholder, s), this.el.appendChild(this.placeholder), s.el = this.placeholder, s._lastUiPosition = i.position, s._prevYPix = i.position.top, s._moving = "dragstart" === e.type, delete s._lastTried, "dropover" === e.type && s._temporaryRemoved && (this.engine.addNode(s), s._moving = !0), this.engine.cacheRects(o, r, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft), "resizestart" === e.type) {
              ...
              s.maxW && e.resizable(t, "option", "maxWidth", o * s.maxW), s.maxH && e.resizable(t, "option", "maxHeight", r * s.maxH)
            }
          }, o.GridStack.prototype._leave = function (t, e) {
            let i = t.gridstackNode;
            i && (n.get().off(t, "drag"), i._temporaryRemoved || (i._temporaryRemoved = !0, this.engine.removeNode(i), i.el = i._isExternal && e ? e : t, !0 === this.opts.removable && l(t, !0), t._gridstackNodeOrig ? (t.gridstackNode = t._gridstackNodeOrig, delete t._gridstackNodeOrig) : i._isExternal && (delete i.el, delete t.gridstackNode, this.engine.restoreInitial())))
            ...
            if ("drag" === e.type) {
              ...
              s._prevYPix = i.position.top, r.Utils.updateScrollPosition(t, i.position, e);
              let l = i.position.left + (i.position.left > s._lastUiPosition.left ? -this.opts.marginRight : this.opts.marginLeft),
                h = i.position.top + (i.position.top > s._lastUiPosition.top ? -this.opts.marginBottom : this.opts.marginTop);
              a.x = Math.round(l / o), a.y = Math.round(h / n);
              let d = this._extraDragRow;
              if (this.engine.collide(s, a)) {
                let t = this.getRow(),
                  e = Math.max(0, a.y + s.h - t);
                this.opts.maxRow && t + e > this.opts.maxRow && (e = Math.max(0, this.opts.maxRow - t)), this._extraDragRow = e
              } else this._extraDragRow = 0;
              if (this._extraDragRow !== d && this._updateContainerHeight(), s.x === a.x && s.y === a.y) return
            } else if ("resize" === e.type) {
              if (a.x < 0) return;
              if (r.Utils.updateScrollResize(e, t, n), a.w = Math.round((i.size.width - this.opts.marginLeft) / o), a.h = Math.round((i.size.height - this.opts.marginTop) / n), s.w === a.w && s.h === a.h) return;
              if (s._lastTried && s._lastTried.w === a.w && s._lastTried.h === a.h) return;
              let h = i.position.left + this.opts.marginLeft,
                d = i.position.top + this.opts.marginTop;
              a.x = Math.round(h / o), a.y = Math.round(d / n), l = !0
            }
            s._lastTried = a;
            let h = {
              x: i.position.left + this.opts.marginLeft,
              y: i.position.top + this.opts.marginTop,
              w: (i.size ? i.size.width : s.w * o) - this.opts.marginLeft - this.opts.marginRight,
              h: (i.size ? i.size.height : s.h * n) - this.opts.marginTop - this.opts.marginBottom
            };
            if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), {
              ...
              s._lastUiPosition = i.position, this.engine.cacheRects(o, n, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft), delete s._skipDown, l && s.subGrid && s.subGrid.onParentResize(), this._extraDragRow = 0, this._updateContainerHeight();
              let t = e.target;
              this._writePosAttr(t, s), this._gsEventHandler[e.type] && this._gsEventHandler[e.type](e, t)
            }
          }, o.GridStack.prototype.movable = function (t, e) {
            return this.opts.staticGrid || o.GridStack.getElements(t).forEach((t => {
              let i = t.gridstackNode;
              i && (e ? delete i.noMove : i.noMove = !0, this._prepareDragDropByNode(i))
            })), this
          }, o.GridStack.prototype.resizable = function (t, e) {
            return this.opts.staticGrid || o.GridStack.getElements(t).forEach((t => {
              let i = t.gridstackNode;
              i && (e ? delete i.noResize : i.noResize = !0, this._prepareDragDropByNode(i))
            })), this
            ...
            return this.opts.staticGrid || (this.opts.disableDrag = !t, this.engine.nodes.forEach((e => this.movable(e.el, t)))), this
          }, o.GridStack.prototype.enableResize = function (t) {
            return this.opts.staticGrid || (this.opts.disableResize = !t, this.engine.nodes.forEach((e => this.resizable(e.el, t)))), this
          }
        },
        334: (t, e) => {
          Object.defineProperty(e, "__esModule", {
        ...
        62: (t, e, i) => {
          ...
          class o {
            ...
            _fixCollisions(t, e = t, i, o = {}) {
              ...
              if (t._moving && !o.nested && !this.float && this.swap(t, i)) return !0;
              let r = e;
              ...
              for (; i = i || this.collide(t, r, o.skip);) {
                ...
                if (i.locked || t._moving && !t._skipDown && e.y > t.y && !this.float && (!this.collide(i, Object.assign(Object.assign({}, i), {
                    ...
                    y: e.y - i.h
                  }), t)) ? (t._skipDown = t._skipDown || e.y > t.y, r = this.moveNode(t, Object.assign(Object.assign(Object.assign({}, e), {
                    y: i.y + i.h
                  }), l)), i.locked && r ? s.Utils.copyPos(e, t) : !i.locked && r && o.pack && (this._packNodes(), e.y = i.y + i.h, s.Utils.copyPos(t, e)), n = n || r) : r = this.moveNode(i, Object.assign(Object.assign(Object.assign({}, i), {
                    y: e.y + e.h,
                    skip: t
                  }), l)), !r) return n;
                i = void 0
            ...
            collideCoverage(t, e, i) {
              ...
              return r.y > o.y ? (r.h += r.y - o.y, r.y = o.y) : r.h += o.y - r.y, r.x > o.x ? (r.w += r.x - o.x, r.x = o.x) : r.w += o.x - r.x, i.forEach((t => {
                if (t.locked || !t._rect) return;
                let e = t._rect,
                  i = Number.MAX_VALUE,
                  n = Number.MAX_VALUE,
                  l = .5;
                o.y < e.y ? i = (r.y + r.h - e.y) / e.h : o.y + o.h > e.y + e.h && (i = (e.y + e.h - r.y) / e.h), o.x < e.x ? n = (r.x + r.w - e.x) / e.w : o.x + o.w > e.x + e.w && (n = (e.x + e.w - r.x) / e.w);
                let a = Math.min(n, i);
                a > l && (l = a, s = t)
              })), s
            }
            ...
            swap(t, e) {
              ...
              function i() {
                let i = e.x,
                  s = e.y;
                return e.x = t.x, e.y = t.y, t.h != e.h ? (t.x = i, t.y = e.y + e.h) : (t.x = i, t.y = s), t._dirty = e._dirty = !0, !0
              }
              let o;
              if (t.w === e.w && t.h === e.h && (t.x === e.x || t.y === e.y) && (o = s.Utils.isTouching(t, e))) return i();
              if (!1 !== o) {
            ...
            compact() {
              ...
              return this.nodes = [], t.forEach((t => {
                t.locked || (t.autoPosition = !0), this.addNode(t, !1), t._dirty = !0
              })), this.commit()
            }
            set float(t) {
            ...
            _packNodes() {
              return this._sortNodes(), this.float ? this.nodes.forEach((t => {
                if (t._updating || void 0 === t._orig || t.y === t._orig.y) return;
                let e = t.y;
                for (; e > t._orig.y;) --e, this.collide(t, {
                  x: t.x,
                  y: e,
                  w: t.w,
                  h: t.h
            ...
            prepareNode(t, e) {
              (t = t || {})._id = t._id || o._idSeq++, void 0 !== t.x && void 0 !== t.y && null !== t.x && null !== t.y || (t.autoPosition = !0);
              let i = {
                x: 0,
                y: 0,
                w: 1,
            ...
            addNode(t, e = !1) {
              let i;
              if (i = this.nodes.find((e => e._id === t._id))) return i;
              if (delete(t = this.prepareNode(t))._temporaryRemoved, delete t._removeDOM, t.autoPosition) {
                this._sortNodes();
                for (let e = 0;; ++e) {
                  let i = e % this.column,
                  ...
                  if (!this.nodes.find((t => s.Utils.isIntercepted(r, t)))) {
                    t.x = i, t.y = o, delete t.autoPosition;
                    break
                  }
                }
              }
            ...
            removeNode(t, e = !0, i = !1) {
              return this.nodes.find((e => e === t)) ? (i && this.removedNodes.push(t), e && (t._removeDOM = !0), this.nodes = this.nodes.filter((e => e !== t)), this._packNodes()._notify(t)) : this
            }
            removeAll(t = !0) {
              return delete this._layouts, 0 === this.nodes.length ? this : (t && this.nodes.forEach((t => t._removeDOM = !0)), this.removedNodes = this.nodes, this.nodes = [], this._notify(this.removedNodes))
            }
            moveNodeCheck(t, e) {
              if (!this.changedPosConstrain(t, e)) return !1;
              if (e.pack = !0, !this.maxRow) return this.moveNode(t, e);
              let i, r = new o({
                column: this.column,
                float: this.float,
                nodes: this.nodes.map((e => e === t ? (i = Object.assign({}, e), i) : Object.assign({}, e)))
              });
              if (!i) return !1;
              let n = r.moveNode(i, e);
              if (this.maxRow && n && (n = r.getRow() <= this.maxRow, !n)) {
                let i = this.collide(t, e);
                if (i && this.swap(t, i)) return this._notify(), !0
              }
            ...
            willItFit(t) {
              ...
              let e = new o({
                ...
                i = Object.assign({}, t);
              return this.cleanupNode(i), delete i.el, delete i._id, delete i.content, delete i.grid, e.addNode(i), e.getRow() <= this.maxRow && (t._willFitPos = s.Utils.copyPos({}, i), !0)
            }
            ...
            moveNode(t, e) {
              ...
              if (s.Utils.copyPos(o, e), o = this.nodeBoundFix(o, i), s.Utils.copyPos(e, o), s.Utils.samePos(t, e)) return !1;
            ...
            layoutsNodesChange(t) {
              return !this._layouts || this._ignoreLayoutsNodeChange || this._layouts.forEach(((e, i) => {
                ...
                i < this.column ? this._layouts[i] = void 0 : t.forEach((t => {
                  ...
                  if (!s) return;
                  let o = i / this.column;
                  t.y !== t._orig.y && (s.y += t.y - t._orig.y), t.x !== t._orig.x && (s.x = Math.round(t.x * o)), t.w !== t._orig.w && (s.w = Math.round(t.w * o))
                }))
              })), this
            }
            updateNodeWidths(t, e, i, o = "moveScale") {
              ...
              0 === r.length && e > t && e < n && (r = this._layouts[n] || [], r.length && (t = n, r.forEach((t => {
              ...
              if (r.forEach((t => {
                ...
                if ("function" == typeof o) o(e, t, l, i);
                  ...
                  i.forEach((i => {
                    i.x = 1 === e ? 0 : r ? Math.round(i.x * s) : Math.min(i.x, e - 1), i.w = 1 === e || 1 === t ? 1 : n ? Math.round(i.w * s) || 1 : Math.min(i.w, e), l.push(i)
                  })), i = []
            ...
            cleanupNode(t) {
              for (let e in t) "_" === e[0] && "_id" !== e && delete t[e];
              return this
            }
          }
        ...
        270: (t, e, i) => {
          ...
          class a {
            constructor(t, e = {}) {
              this._gsEventHandler = {}, this._extraDragRow = 0, this.el = t, (e = e || {}).row && (e.minRow = e.maxRow = e.row, delete e.row);
              let i = r.Utils.toNumber(t.getAttribute("gs-row")),
                s = Object.assign(Object.assign({}, l), {
                  column: r.Utils.toNumber(t.getAttribute("gs-column")) || 12,
                  minRow: i || r.Utils.toNumber(t.getAttribute("gs-min-row")) || 0,
                  maxRow: i || r.Utils.toNumber(t.getAttribute("gs-max-row")) || 0,
                  staticGrid: r.Utils.toBool(t.getAttribute("gs-static")) || !1,
              ...
              if (n && n.gridstackNode && (this.opts._isNested = n.gridstackNode, this.opts._isNested.subGrid = this, this.el.classList.add("grid-stack-nested")), this._isAutoCellHeight = "auto" === this.opts.cellHeight, this._isAutoCellHeight || "initial" === this.opts.cellHeight ? this.cellHeight(void 0, !1) : this.cellHeight(this.opts.cellHeight, !1), this.el.classList.add(this.opts._styleSheetClass), this._setStaticClass(), this.engine = new o.GridStackEngine({
                  ...
                  onChange: t => {
                    ...
                    this.engine.nodes.forEach((t => {
                      ...
                      let e = t.el;
                      t._removeDOM ? (e && e.remove(), delete t._removeDOM) : this._writePosAttr(e, t)
                ...
                })), t.sort(((t, e) => t.i - e.i)).forEach((t => this._prepareElement(t.el))), this.commit()
              }
            ...
            static initAll(t = {}, e = ".grid-stack") {
              ...
              return a.getGridElements(e).forEach((e => {
                e.gridstack || (e.gridstack = new a(e, Object.assign({}, t)), delete t.dragIn, delete t.dragInOptions), i.push(e.gridstack)
            ...
            static addGrid(t, e = {}) {
              ...
              if (!t.classList.contains("grid-stack")) {
                ...
                s.body.innerHTML = `<div class="grid-stack ${e.class||""}"></div>`, i = s.body.children[0], t.appendChild(i)
              }
              let s = a.init(e, i);
              if (s.opts.children) {
            ...
            addWidget(t, e) {
              ...
              e = Object.assign({}, e || {}), r.Utils.defaults(e, o);
              let n = this.engine.prepareNode(e);
              if (this._writeAttr(i, e), this._insertNotAppend ? this.el.prepend(i) : this.el.appendChild(i), this._prepareElement(i, !0, e), this._updateContainerHeight(), n.subGrid && !n.subGrid.el) {
                let t = n.el.querySelector(".grid-stack-item-content");
                n.subGrid = a.addGrid(t, n.subGrid)
              }
            ...
            load(t, e = !0) {
              ...
              return this.batchUpdate(), e && [...this.engine.nodes].forEach((t => {
                ...
                } else e && (t = "function" == typeof e ? e(this, t, !0).gridstackNode : this.addWidget(t).gridstackNode)
            ...
            setStatic(t, e = !0) {
              return this.opts.staticGrid === t || (this.opts.staticGrid = t, this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((t => this._prepareDragDropByNode(t))), e && this._setStaticClass()), this
            }
            update(t, e) {
              if (arguments.length > 2) {
              ...
              return a.getElements(t).forEach((t => {
                ...
                let o, r = ["x", "y", "w", "h"];
                if (r.some((t => void 0 !== s[t] && s[t] !== i[t])) && (o = {}, r.forEach((t => {
                ...
                o && (this.engine.cleanNodes().beginUpdate(i).moveNode(i, o), this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate()), n && this._writeAttr(t, i), l && this._prepareDragDropByNode(i)
              })), this
            }
            margin(t) {
              if (!("string" == typeof t && t.split(" ").length > 1)) {
                let e = r.Utils.parseHeight(t);
            ...
            _updateStyles(t = !1, e) {
              ...
              if (!this._styles) {
                ...
                if (this._styles = r.Utils.createStylesheet(t, e), !this._styles) return this;
                this._styles._id = t, this._styles._max = 0, r.Utils.addCSSRule(this._styles, o, `min-height: ${i}${s}`);
                ...
                r.Utils.addCSSRule(this._styles, d, `top: ${n}; right: ${a}; bottom: ${l}; left: ${h};`), r.Utils.addCSSRule(this._styles, g, `top: ${n}; right: ${a}; bottom: ${l}; left: ${h};`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-ne`, `right: ${a}`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-e`, `right: ${a}`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-se`, `right: ${a}; bottom: ${l}`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-nw`, `left: ${h}`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-w`, `left: ${h}`), r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-sw`, `left: ${h}; bottom: ${l}`)
              }
              if ((e = e || this._styles._max) > this._styles._max) {
                let t = t => i * t + s;
                for (let i = this._styles._max + 1; i <= e; i++) {
                  let e = t(i);
                  r.Utils.addCSSRule(this._styles, `${o}[gs-y="${i-1}"]`, `top: ${t(i-1)}`), r.Utils.addCSSRule(this._styles, `${o}[gs-h="${i}"]`, `height: ${e}`), r.Utils.addCSSRule(this._styles, `${o}[gs-min-h="${i}"]`, `min-height: ${e}`), r.Utils.addCSSRule(this._styles, `${o}[gs-max-h="${i}"]`, `max-height: ${e}`)
                }
                this._styles._max = e
              }
              return this
            ...
            _prepareElement(t, e = !1, i) {
              ...
              return i = this.engine.addNode(i, e), r.Utils.same(i, s) || this._writeAttr(t, i), this._prepareDragDropByNode(i), this
            }
            _writePosAttr(t, e) {
            ...
            _readAttr(t) {
              let e = {};
              e.x = r.Utils.toNumber(t.getAttribute("gs-x")), e.y = r.Utils.toNumber(t.getAttribute("gs-y")), e.w = r.Utils.toNumber(t.getAttribute("gs-w")), e.h = r.Utils.toNumber(t.getAttribute("gs-h")), e.maxW = r.Utils.toNumber(t.getAttribute("gs-max-w")), e.minW = r.Utils.toNumber(t.getAttribute("gs-min-w")), e.maxH = r.Utils.toNumber(t.getAttribute("gs-max-h")), e.minH = r.Utils.toNumber(t.getAttribute("gs-min-h")), e.autoPosition = r.Utils.toBool(t.getAttribute("gs-auto-position")), e.noResize = r.Utils.toBool(t.getAttribute("gs-no-resize")), e.noMove = r.Utils.toBool(t.getAttribute("gs-no-move")), e.locked = r.Utils.toBool(t.getAttribute("gs-locked")), e.resizeHandles = t.getAttribute("gs-resize-handles"), e.id = t.getAttribute("gs-id");
              for (const t in e) {
            ...
            static getElement(t = ".grid-stack-item") {
              return r.Utils.getElement(t)
            }
            static getElements(t = ".grid-stack-item") {
              return r.Utils.getElements(t)
            }
            ...
            initMargin() {
              let t, e = 0,
                i = [];
              return "string" == typeof this.opts.margin && (i = this.opts.margin.split(" ")), 2 === i.length ? (this.opts.marginTop = this.opts.marginBottom = i[0], this.opts.marginLeft = this.opts.marginRight = i[1]) : 4 === i.length ? (this.opts.marginTop = i[0], this.opts.marginRight = i[1], this.opts.marginBottom = i[2], this.opts.marginLeft = i[3]) : (t = r.Utils.parseHeight(this.opts.margin), this.opts.marginUnit = t.unit, e = this.opts.margin = t.h), void 0 === this.opts.marginTop ? this.opts.marginTop = e : (t = r.Utils.parseHeight(this.opts.marginTop), this.opts.marginTop = t.h, delete this.opts.margin), void 0 === this.opts.marginBottom ? this.opts.marginBottom = e : (t = r.Utils.parseHeight(this.opts.marginBottom), this.opts.marginBottom = t.h, delete this.opts.margin), void 0 === this.opts.marginRight ? this.opts.marginRight = e : (t = r.Utils.parseHeight(this.opts.marginRight), this.opts.marginRight = t.h, delete this.opts.margin), void 0 === this.opts.marginLeft ? this.opts.marginLeft = e : (t = r.Utils.parseHeight(this.opts.marginLeft), this.opts.marginLeft = t.h, delete this.opts.margin), this.opts.marginUnit = t.unit, this.opts.marginTop === this.opts.marginBottom && this.opts.marginLeft === this.opts.marginRight && this.opts.marginTop === this.opts.marginRight && (this.opts.margin = this.opts.marginTop), this
            }
          ...
          e.GridStack = a, a.Utils = r.Utils, a.Engine = o.GridStackEngine
        },
        861: (t, e) => {
          Object.defineProperty(e, "__esModule", {
            value: !0
          ...
          class n extends o.DDBaseImplement {
            ...
            _dragLeave(t) {
              if (t.relatedTarget) {
                ...
                if (t.x < s && t.x > i && t.y < e && t.y > o) return
              }
            ...
            _drop(t) {
              ...
              this.option.drop && this.option.drop(e, this._ui(s.DDManager.dragElement)), this.triggerEvent("drop", e), this._removeLeaveCallbacks(), delete this.moving
            }
        ...
        97: (t, e, i) => {
          ...
          class l extends o.DDBaseImplement {
            ...
            _resizeStart(t) {
              this.originalRect = this.el.getBoundingClientRect(), this.scrollEl = n.Utils.getScrollElement(this.el), this.scrollY = this.scrollEl.scrollTop, this.startEvent = t, this._setupHelper(), this._applyChange();
              const e = r.DDUtils.initEvent(t, {
                type: "resizestart",
                target: this.el
              });
            ...
            _getChange(t, e) {
              ...
              e.indexOf("e") > -1 ? s.width += o : e.indexOf("w") > -1 && (s.width -= o, s.left += o), e.indexOf("s") > -1 ? s.height += r : e.indexOf("n") > -1 && (s.height -= r, s.top += r);
              const n = this._constrainSize(s.width, s.height);
              return Math.round(s.width) !== Math.round(n.width) && (e.indexOf("w") > -1 && (s.left += s.width - n.width), s.width = n.width), Math.round(s.height) !== Math.round(n.height) && (e.indexOf("n") > -1 && (s.top += s.height - n.height), s.height = n.height), s
            }
            _constrainSize(t, e) {
        ...
        943: (t, e) => {
          ...
          class i {
            ...
            static appendTo(t, e) {
              let i;
              i = "string" == typeof e ? document.querySelector(e) : e, i && i.appendChild(t)
            }
        ...
        761: (t, e, i) => {
          ...
          class l extends r.GridStackDD {
            ...
            _getDDElements(t, e = !0) {
              ...
              if (!i.length) return [];
              let s = i.map((t => t.ddElement || (e ? o.DDElement.init(t) : null)));
              return e || s.filter((t => t)), s
            }
          }
          e.GridStackDDNative = l, r.GridStackDD.registerPlugin(l)
        },
        593: (t, e) => {
          Object.defineProperty(e, "__esModule", {
            value: !0
          }), e.obsolete = function (t, e, i, s, o) {
            let r = (...r) => (console.warn("gridstack.js: Function `" + i + "` is deprecated in " + o + " and has been replaced with `" + s + "`. It will be **completely** removed in v1.0"), e.apply(t, r));
            ...
            null !== o && (t.setAttribute(i, o), console.warn("gridstack.js: attribute `" + e + "`=" + o + " is deprecated on this object in " + s + " and has been replaced with `" + i + "`. It will be **completely** removed in v1.0"))
          };
          class i {
            ...
            static sort(t, e, i) {
              return i = i || t.reduce(((t, e) => Math.max(e.x + e.w, t)), 0) || 12, -1 === e ? t.sort(((t, e) => e.x + e.y * i - (t.x + t.y * i))) : t.sort(((t, e) => t.x + t.y * i - (e.x + e.y * i)))
            }
            ...
            static removeInternalAndSame(t, e) {
              if ("object" == typeof t && "object" == typeof e)
                for (let i in t) {
                  let s = t[i];
                  if (s && "object" == typeof s && void 0 !== e[i]) {
            ...
            static getScrollElement(t) {
              if (!t) return document.scrollingElement;
            ...
            static updateScrollPosition(t, e, i) {
              ...
              if (s.top < 0 || s.bottom > o) {
                ...
                if (null !== l) {
                  let a = l.scrollTop;
                  s.top < 0 && i < 0 ? t.offsetHeight > o ? l.scrollTop += i : l.scrollTop += Math.abs(n) > Math.abs(i) ? i : n : i > 0 && (t.offsetHeight > o ? l.scrollTop += i : l.scrollTop += r > i ? i : r), e.top += l.scrollTop - a
                }
              }
            }
